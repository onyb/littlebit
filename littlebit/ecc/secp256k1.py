...
class S256Point(Point):
    def __init__(self, x, y, a=None, b=None):
        ...
        if isinstance(x, int) and isinstance(y, int):
            super().__init__(x=S256FieldElement(x), y=S256FieldElement(y))
        elif isinstance(x, S256FieldElement) and isinstance(y, S256FieldElement):
            super().__init__(x=x, y=y)
        else:
            raise TypeError("x and y must be of type int or S256FieldElement")
